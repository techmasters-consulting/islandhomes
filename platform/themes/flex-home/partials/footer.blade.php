            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="newsletter_form2 rounded_input">
                        <form id="ajaxSubmit" >
                            @csrf
                            <input type="text" required="" id="email" name="email" class="form-control" placeholder="Enter Email Address">
	...
	text-transform: capitalize;">Sign up To Islandhomes Newsletter!</h3>
                            ...
                            <form  id="ajaxSubmits">
                                ...
                                <div class="form-group">
                                    <input name="email" id="emails" required="" type="email" class="form-control" placeholder="Enter Your Email">
                                </div>
                                <div class="form-group">
