                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            <label class="text-title-field" for="cod_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                            <input type="text" class="next-input" name="cod_name" id="cod_name" data-counter="400" value="{{ setting('payment_cod_name', \Botble\Payment\Enums\PaymentMethodEnum::COD()->label()) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-title-field" for="cod_description">{{ trans('plugins/payment::payment.payment_method_description') }}</label>
                                            <textarea class="next-input" name="cod_description" id="cod_description">{{ setting('payment_cod_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            <label class="text-title-field" for="bank_transfer_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                            <input type="text" class="next-input" name="bank_transfer_name" id="bank_transfer_name" data-counter="400" value="{{ setting('payment_bank_transfer_name', \Botble\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-title-field" for="bank_transfer_description">{{ trans('plugins/payment::payment.payment_method_description') }}</label>
                                            <textarea class="next-input" name="bank_transfer_description" id="bank_transfer_description">{{ setting('payment_bank_transfer_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">
