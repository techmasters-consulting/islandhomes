                ...
                @if (setting('payment_paypal_status') == 1)
                    <li class="list-group-item">
                        ...
                        <label for="payment_paypal"
                               class="text-left">{{ trans('plugins/payment::payment.payment_via_paypal') }}</label>
                    </li>
                @endif
            </ul>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('payments.checkout') }}" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary disableBtn" data-dismiss="modal">Close
                            </button>
                            ...
                            <button type="button"
                                    class="payment-checkout-btn btn btn-info">{{ __('Checkout') }}</button>
