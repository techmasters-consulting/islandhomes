...
class BackupCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cms:backup {name : The name of backup} {--description= : The description}';
    ...
    public function handle()
    {
        try {
            ...
            $this->info('Done! The backup folder is located in ' . storage_path('app/backup/') . $data['key'] . '!');
